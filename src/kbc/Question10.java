...
public class Question10 extends javax.swing.JFrame {
 ...
 if(flag==0){ jLabel1.setText("WHICH COLONIAL POWER ENDED IT'S INVOLVEMENT IN INDIA BY SELLING THE RIGHTS OF THE NICOBAR ISLANDS TO THE BRITISH ON OCTOBER 18,1868");                                       
btnstart.setText("BELGIUM");
btnstop.setText("ITALY");
btnstop1.setText("DENMARK");
btnstop2.setText("FRANCE");
       Timer t;
    t=new Timer(1000,new ActionListener() {
      ...
      t.start();
      flag=1;}
  else if(flag==1){ Lose l=new Lose();
    ...
    private void btnstop2ActionPerformed(java.awt.event.ActionEvent evt) {                                         
     if(flag==1||flag==0){ Lose l=new Lose();
        l.setExtendedState(MAXIMIZED_BOTH);l.setVisible(true);
     this.dispose();
     flag=1;
     }
...
q2.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Question10 k=new Question10();
                k.getContentPane().setBackground(Color.CYAN);
                k.setTitle("Question:10");
