...
public class Question11 extends javax.swing.JFrame {
 ...
 if(flag==0){ jLabel1.setText("WHICH OF THESE INDIAN CITIES IS CLOSEST TO THE PAKISTANI CITY LAHORE");                                       
btnstart.setText("SRINAGAR");
btnstop.setText("JAISALMER");
btnstop1.setText("AMRITSAR");
btnstop2.setText("UDHAMPUR");
       Timer t;
 ...
 if(flag==0){ Lose l=new Lose();   l.setExtendedState(MAXIMIZED_BOTH);    l.getContentPane().setBackground(Color.CYAN);
  ...
  if(flag==1)
     {
          Question12 q2=new Question12();   q2.setExtendedState(MAXIMIZED_BOTH);    q2.getContentPane().setBackground(Color.CYAN);
q2.setVisible(true);
     this.dispose();}// TODO add your handling code here:
    }                                        
