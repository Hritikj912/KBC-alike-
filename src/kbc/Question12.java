...
public class Question12 extends javax.swing.JFrame {
 ...
 if(flag==0){ jLabel1.setText("IN JULY 2017, NARENDRA MODI BECOME THE FIRST PRIME MINISTER TO VISIT WHICH COUNTRY");                                       
btnstart.setText("ISRAEL");
btnstop.setText("SAUDI ARAB");
btnstop1.setText("QATAR");
btnstop2.setText("JORDAN");
       Timer t;
    t=new Timer(1000,new ActionListener() {
     ...
     {
          Question13 q2=new Question13();q2.setExtendedState(MAXIMIZED_BOTH); q2.getContentPane().setBackground(Color.CYAN);
q2.setVisible(true);
     this.dispose();}
    }                                        
  ...
  if(flag==0||flag==1){ Lose l=new Lose();   l.setExtendedState(MAXIMIZED_BOTH);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Question12 k=new Question12();
                k.getContentPane().setBackground(Color.CYAN);
                k.setTitle("Question:12");
