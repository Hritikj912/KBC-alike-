...
public class Question19 extends javax.swing.JFrame {
 ...
 if(flag==0){ jLabel1.setText("WHICH OF THESE SPORTS EVENTS IS NAMED AFTER A PLACE");                                       
btnstart.setText("TENNIS");
btnstop.setText("SOCCER");
btnstop1.setText("MARATHON ");
btnstop2.setText("SQUASH");
       Timer t;
    t=new Timer(1000,new ActionListener() {
      ...
      t.start();
      flag=1;}
 else if(flag==1){ Lose l=new Lose();l.setExtendedState(MAXIMIZED_BOTH);    l.getContentPane().setBackground(Color.CYAN);
     l.setVisible(true);
     this.dispose();}
    }                                        

    private void btnstop2ActionPerformed(java.awt.event.ActionEvent evt) {                                         
     if(flag==0){ Lose l=new Lose();l.setExtendedState(MAXIMIZED_BOTH);    l.getContentPane().setBackground(Color.CYAN);
     l.setVisible(true);
     this.dispose();flag=1;
     }
     else if(flag==1){ Lose l=new Lose();l.setExtendedState(MAXIMIZED_BOTH);    l.getContentPane().setBackground(Color.CYAN);
 ...
 if(flag==0){ Lose l=new Lose();l.setExtendedState(MAXIMIZED_BOTH);    l.getContentPane().setBackground(Color.CYAN);
  ...
  if(flag==0){ Lose l=new Lose();
     l.setExtendedState(MAXIMIZED_BOTH);    l.getContentPane().setBackground(Color.CYAN);l.setVisible(true);
     this.dispose();
     flag=1;}     
  else if(flag==1)
     {
          Question21 q2=new Question21();
          q2.setExtendedState(MAXIMIZED_BOTH);    q2.getContentPane().setBackground(Color.CYAN);
q2.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Question19 k=new Question19();
                k.getContentPane().setBackground(Color.CYAN);
                k.setTitle("Question:15");
