...
public class Question2 extends javax.swing.JFrame {
 ...
 if(flag==0){  jLabel1.setText("WHICH OF THESE ACTOR HA FEATRURED IN ALL THREE FILMS OF RACE SERIES");                                       
btnstart.setText("AMISHA PATEL");
btnstop.setText("SAIF ALI KHAN");
btnstop1.setText("JAQUELINE FERNANDEZ");
btnstop2.setText("ANIL KAPOOR");
       Timer t;
 ...
 else if(flag==1)
     {
          Lose q2=new Lose();
             q2.setExtendedState(MAXIMIZED_BOTH);
                 q2.getContentPane().setBackground(Color.CYAN);
q2.setVisible(true);
this.dispose();
     }
    }                                        
    ...
    private void btnstop2ActionPerformed(java.awt.event.ActionEvent evt) {                                         
     if(flag==0){ Lose l=new Lose();
        l.setExtendedState(MAXIMIZED_BOTH);    l.getContentPane().setBackground(Color.CYAN);
     l.setVisible(true);
     this.dispose();
     flag=1;
     }
...
this.dispose();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        ...
        q1.getContentPane().setBackground(Color.CYAN);
q1.setVisible(true);
    }                                        
