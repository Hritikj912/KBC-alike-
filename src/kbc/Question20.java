...
jLabel1.setText("WHICH OF THESE POLITICIANS HAS BEEN THE PRESIDENTS OF THE INDIAN NATIONAL CONGRESS FOR THE LONGEST PERIOD");                                       
btnstart.setText("JAWAHARLAL NEHRU");
btnstop.setText("INDIRA GANDHI");
btnstop1.setText("RAJIV GANDHI");
btnstop2.setText("SONIA GANDHI");
       Timer t;
...
btnstop2.setText("SONIA GANDHI");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Question20 k=new Question20();
                k.getContentPane().setBackground(Color.CYAN);
                k.setTitle("Question:20");
                k.setVisible(true);
            }
        });
    }
