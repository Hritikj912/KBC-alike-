...
public class Question21 extends javax.swing.JFrame {
 ...
 if(flag==0){ jLabel1.setText("IN 1846, WHAT WAS BOUGHT BY GULAB SINGH FROM THE BRITISH FOR 75 LAKHS");                                       
btnstart.setText("SIMLA");
btnstop.setText("KUMAON");
btnstop1.setText("KASHMIR");
btnstop2.setText("GAHRWAL");
       Timer t;
 ...
 if(flag==0||flag==1){ Lose l=new Lose();l.setExtendedState(MAXIMIZED_BOTH);
  ...
  if(flag==0){ Lose l=new Lose();
     l.setExtendedState(MAXIMIZED_BOTH);l.setVisible(true);
     this.dispose();
     flag=1;} 
  else if(flag==1)
     {
          Question22 q2=new Question22();
...
q2.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Question21 k=new Question21();
                k.getContentPane().setBackground(Color.CYAN);
                k.setTitle("Question:16");
