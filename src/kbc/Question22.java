...
public class Question22 extends javax.swing.JFrame {
 ...
 if(flag==0){ jLabel1.setText("WHAT WAS THE NAME OF INDIA'S FIRST TUBE BABY DEVELOPED USING IVF TECHNIQUE BY DR. SUBHAS MUKHERJEE");                                       
btnstart.setText("LAKSHMI");
btnstop.setText("SARASWATI");
btnstop1.setText("KALI");
btnstop2.setText("DURGA");
       Timer t;
    t=new Timer(1000,new ActionListener() {
      ...
      t.start();
      flag=1;}
 else if(flag==1){ Lose l=new Lose();l.setExtendedState(MAXIMIZED_BOTH);
      l.getContentPane().setBackground(Color.CYAN);l.setVisible(true);
     this.dispose();}
    }                                        
    ...
    l.getContentPane().setBackground(Color.CYAN);  l.setVisible(true);
     ...
     {
          Question23 q2=new Question23();q2.setExtendedState(MAXIMIZED_BOTH);
 q2.getContentPane().setBackground(Color.CYAN);q2.setVisible(true);
     this.dispose();}
    }                                        

    private void btnstopActionPerformed(java.awt.event.ActionEvent evt) {                                        
 if(flag==0||flag==1){ Lose l=new Lose();l.setExtendedState(MAXIMIZED_BOTH);
     l.getContentPane().setBackground(Color.CYAN); l.setVisible(true);
     this.dispose();flag=1;
