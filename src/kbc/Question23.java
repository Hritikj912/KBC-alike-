...
public class Question23 extends javax.swing.JFrame {
 ...
 if(flag==0){ jLabel1.setText("WHO IS THE FIRST WOMAN TO SUCCESSFULLY CLIMB K2, THE WORLD'S SECOND HIGHEST MOUNTAIN PEAK");                                       
btnstart.setText("JUNKO TABEI");
btnstop.setText("WANDA RUTKLEWICZ");
btnstop1.setText("TAMAE WATANABE");
btnstop2.setText("CHANTAL MAUDUIT");
       Timer t;
 ...
 if(flag==0){ Lose l=new Lose();l.setExtendedState(MAXIMIZED_BOTH);
   ...
   if(flag==1)
     {
          Win q2=new Win();q2.setExtendedState(MAXIMIZED_BOTH); q2.getContentPane().setBackground(Color.CYAN);
q2.setVisible(true);
     this.dispose();}
    }                                       
