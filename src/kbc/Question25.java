...
public class Question25 extends javax.swing.JFrame {
 ...
 if(flag==0){ jLabel1.setText("HIGHEST AWARD IN THE COMPUTER SCIENCE IS NAMED AFTER WHOM ?");                                       
btnstart.setText("ELAN TURING");
btnstop.setText("BJARNE STROSTRUP");
btnstop1.setText("STEVE JOBS");
btnstop2.setText("DENIS RITCHIE");
       Timer t;
 ...
 if(flag==0){ Lose l=new Lose();l.setExtendedState(MAXIMIZED_BOTH);
   ...
   if(flag==1)
     {
          Win q2=new Win();q2.setExtendedState(MAXIMIZED_BOTH);
