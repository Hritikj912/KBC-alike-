...
public class Question6 extends javax.swing.JFrame {
 ...
 if(flag==0){ jLabel1.setText("WHICH VARIETY OF MANGO IS THE NAME OF AN EXPENSIVE SPICE");                                       
btnstart.setText("CHAUSA");
btnstop.setText("LANGRA");
btnstop1.setText("KESAR");
btnstop2.setText("ALPHONSO");
       Timer t;
...
q2.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Question6 k=new Question6();
                k.getContentPane().setBackground(Color.CYAN);
                k.setTitle("Question:6");
