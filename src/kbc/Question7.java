...
public class Question7 extends javax.swing.JFrame {
 ...
 if(flag==0){ jLabel1.setText("WHICH OF THESE IS DETERMINED USING A COMPASS");                                       
btnstart.setText("SPEED");
btnstop.setText("DISTANCE");
btnstop1.setText("DIRECTION");
btnstop2.setText("HEIGHT");
       Timer t;
...
q2.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Question7 k=new Question7();
                k.getContentPane().setBackground(Color.CYAN);
                k.setTitle("Question:7");
