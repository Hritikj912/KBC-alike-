...
public class Question8 extends javax.swing.JFrame {
 ...
 if(flag==0){jLabel1.setText("IN WHICH FILM DID THIS SONG FEATURE 'HUM CHALE BAHAARON MEIN, AB KYA KAREIN '");                                       
btnstart.setText("TAMASHA");
btnstop.setText("PIKU");
btnstop1.setText("DIL DHADAKNE DO");
btnstop2.setText("SHANDAAR");
       Timer t;
   ...
   if(flag==1){ Lose l=new Lose();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Question8 k=new Question8();
                k.getContentPane().setBackground(Color.CYAN);
                k.setTitle("Question:8");
