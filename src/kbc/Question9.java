...
public class Question9 extends javax.swing.JFrame {
 ...
 if(flag==0){ jLabel1.setText("ACCORDING TO HINDU MYTHOLOGY, WHICH DEMON ASSASSIN WAS SENT BY KANSA TO KILL LORD KRISHNA");                                       
btnstart.setText("PUTANA");
btnstop.setText("KALIYA");
btnstop1.setText("HIDIMBAA");
btnstop2.setText("BARBARIKA");
       Timer t;
  ...
  if(flag==0){ Lose l=new Lose();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Question9 k=new Question9();
                k.getContentPane().setBackground(Color.CYAN);
                k.setTitle("Question:9");
